...
vim.api.nvim_create_autocmd("LspAttach", { 
    callback = function(args)
        ...
        keymap('d]', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', bufopts, "Go to next diagnostic")
        keymap('d[', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', bufopts, "Go to prvious diagnostic")
